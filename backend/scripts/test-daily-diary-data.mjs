...
const parsed = parseRolloutLines([
  ...
  event({ type: 'message', role: 'assistant', phase: 'commentary', content: [{ type: 'output_text', text: '过程' }] }),
...
assert.deepEqual(parsed.conversations, [{ turnId: 'a', timestamp: '2026-08-16T10:00:00+02:00', user: '修复采集', assistant: '已经修好' }]);
